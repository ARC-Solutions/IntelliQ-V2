...
import { quizzes, multiplayerQuizSubmissions, rooms, users, questions, userResponses, userUsageData, documents, bookmarks, sharedQuizzes, userAnalysis } from "./schema";
