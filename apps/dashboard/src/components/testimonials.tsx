  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-2">
        <img className="rounded-full" width="32" height="32" alt={alt} src={img} />
...
export function Testimonials() {
  return (
    ...
    <div className="relative h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg md:shadow-xl">
