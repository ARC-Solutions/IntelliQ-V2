              ...
              <Controller
                ...
                render={({ field }) => (
                  <Slider
                    ...
                    max={100}
                    step={5}
                    onValueChange={(value) => setPassingScoreValue(Math.max(5, value[0]))} // Enforce minimum of 5
                    value={[formValues.passingScore < 5 ? 0 : formValues.passingScore]} // Show 0 if below 5
                    className='flex-grow'
                  />
                )}
              />
