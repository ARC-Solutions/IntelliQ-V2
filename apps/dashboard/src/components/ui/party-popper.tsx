...
const PartyPopperIcon = forwardRef<PartyPopperIconHandle, PartyPopperIconProps>(
  (
    ...
    // Effect to animate confetti when showConfetti changes
    useEffect(() => {
      if (showConfetti) {
        confettiControls.start("animate");
      } else {
        confettiControls.start("normal");
      }
    }, [showConfetti, confettiControls]);
    ...
    const handleMouseEnter = useCallback(
      ...
      [controls, confettiControls, onMouseEnter, showConfetti],
    );
    ...
    const handleMouseLeave = useCallback(
      ...
      [controls, confettiControls, onMouseLeave, showConfetti],
    );
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Always render confetti paths but control their visibility with animation */}
          <motion.path
            d="M4 3h.01"
            variants={dotsVariants}
            animate={confettiControls}
            initial={showConfetti ? "animate" : "normal"}
          />
          <motion.path
            d="M22 8h.01"
            variants={dotsVariants}
