...
import { Award, Clock, CheckCircle2, Calendar, User, Tag, BookOpen, Globe, EyeOff } from 'lucide-react';
...
export default function SharedQuizPage({ params }: { params: { shareId: string } }) {
  ...
  const { userScore, correctAnswersCount, questionsCount, totalTimeTaken, passed } = quiz.quiz;
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-primary text-4xl font-bold">{userScore}%</span>
                </div>
              </div>
          ...
          <CardFooter className="flex flex-col gap-4 px-6">
            <div className="flex flex-wrap justify-between w-full gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Created: {new Date(quiz.quiz.createdAt).toLocaleDateString()}</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Passing Score: {quiz.quiz.passingScore}%</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">{quiz.isPublic ? "Public" : "Private"} Quiz</span>
              </div>
            </div>
            ...
            {!quiz.isAnonymous && (
              <div className="flex items-center gap-2 mt-2">
                <User className="text-primary" size={16} />
                <span className="text-sm">Shared by: {quiz.quiz.createdBy}</span>
              </div>
            )}
          </CardFooter>
        </Card>
