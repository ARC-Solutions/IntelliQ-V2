...
export default function NotFoundPage() {
  ...
  return (
    <div className="min-h-[100dvh] w-full relative opacity-0 [animation-delay:.85s] animate-fade-in-down">
      ...
      <div className="isolate relative w-full py-10 sm:py-20 lg:py-40 [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
        ...
        <div className="mx-auto px-4 sm:px-6 md:px-8 max-w-[1200px] relative">
          <div className="relative w-full">
            <div className="relative flex flex-col gap-4 sm:gap-6 lg:gap-8 text-primary-foreground/50 dark:text-primary/50">
              <GridBorder left right overflow />

              <div className="relative flex flex-col w-full text-primary-foreground">
                <span className="relative !leading-[.76] text-6xl sm:text-8xl lg:text-[200px] font-bold -tracking-[.06em] -ml-[.7%]">
                  <div
                    aria-hidden
              ...
              <div className="relative flex flex-col w-full text-primary-foreground">
                ...
                <span className="!leading-[1.1] text-3xl sm:text-4xl lg:text-6xl xl:text-[7.125rem] -tracking-[.06em] -ml-1 shadow-2xl dark:text-white">
              ...
              <div className="relative flex flex-col w-full">
                ...
                <Link href="/" className="w-max">
                  <Button
                    variant="default"
                    size="lg"
                    className="h-10 sm:h-12 lg:h-14 text-base sm:text-lg transition-colors"
                  >
                    Return to IntelliQ
              ...
              <div className="relative flex flex-col w-full mt-4 text-base sm:text-lg lg:text-2xl xl:text-4xl">
                <GridBorder top />
...
function IntelliQBackground() {
  return (
    ...
    >
      <defs>
        <pattern id="intelliq-pattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
          <circle cx="20" cy="20" r="1" fill="currentColor" className="text-primary-foreground dark:text-white" />
          <path
